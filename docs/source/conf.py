# -*- coding: utf-8 -*-
#
# rawdisk documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('../../rawdisk'))

# Import project metadata
from rawdisk import metadata
...
latex_documents = [
  ('index', metadata.project_no_spaces + '.tex', 
    metadata.project_no_spaces + ' Documentation',
   metadata.authors_string, 'manual'),
]
...
texinfo_documents = [
  ('index', metadata.project_no_spaces, metadata.project + ' Documentation',
   metadata.authors_string, metadata.project_no_spaces, metadata.description,
   'Miscellaneous'),
]
